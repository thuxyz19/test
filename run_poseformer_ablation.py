...
if args.model_type == 'no-ext':
    model_pos_train = NoExt(num_frame=receptive_field, num_joints=num_joints, in_chans=2,
...
elif args.model_type == 'no-group':
    model_pos_train = NoGroup(num_frame=receptive_field, num_joints=num_joints, in_chans=2,
                            embed_dim_ratio=args.embed_ratio, depth=4,
                            num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,
                            drop_path_rate=args.droppath, M=9, shift=3, seed=ref_3D, drop_rate=args.dropout)
else:
...
if args.model_type == 'no-ext':
    model_pos = NoExt(num_frame=receptive_field, num_joints=num_joints, in_chans=2,
                      embed_dim_ratio=args.embed_ratio, depth=4,
                      num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,
                      drop_path_rate=0.0, M=9, shift=3, seed=ref_3D, drop_rate=args.dropout)
elif args.model_type == 'no-group':
    model_pos = NoGroup(num_frame=receptive_field, num_joints=num_joints, in_chans=2,
                      embed_dim_ratio=args.embed_ratio, depth=4,
                      num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,
                      drop_path_rate=0.0, M=9, shift=3, seed=ref_3D, drop_rate=args.dropout)
else:
