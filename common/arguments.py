...
def parse_args():
    ...
    parser.add_argument('--k_norm', action='store_true', help='normalize input with K inv')
    parser.add_argument('--bone_norm', action='store_true', help='normalize gt with bone length')
    parser.add_argument('--inter', action='store_true', help='add intermediate loss for group Transformer')
    parser.add_argument('--merge', action='store_true', help='merge multi-group information through anchors')
    parser.add_argument('--torch-loader', action='store_true', help='using dataloader from pytorch')
    parser.add_argument('--ST', action='store_true', help='process features spatially first')
    parser.add_argument('--weighted', action='store_true', help='process features spatially first')
    parser.add_argument('--attack', action='store_true', help='process features spatially first')
    parser.add_argument('--motion-loss', action='store_true', help='process features spatially first')
    parser.add_argument('--BN', action='store_true', help='using BN')
    # Model arguments
    parser.add_argument('-s', '--stride', default=1, type=int, metavar='N', help='chunk size to use during training')
    parser.add_argument('-e', '--epochs', default=200, type=int, metavar='N', help='number of training epochs')
    parser.add_argument('-seed', '--seed', default=666, type=int, metavar='N', help='seed')
    ...
    parser.add_argument('-dp', '--droppath', default=0.1, type=float, metavar='P', help='droppath rate')
    ...
    parser.add_argument('--model-type', type=str, default='poseformer', help='type of model')
    parser.add_argument('--merge-type', type=str, default='mean', help='type of merge')
    parser.add_argument('--pos-type', type=str, default='learnable', help='type of position embedding')
    parser.add_argument('--embed-ratio', default=32, type=int, metavar='N', help='the embed ratio of the model')
    parser.add_argument('--factor-q', default=1, type=int, metavar='N', help='the scaling factor for q')
    parser.add_argument('--factor-k', default=3, type=int, metavar='N', help='the scaling factor for k')
    parser.add_argument('--num-workers', default=4, type=int, metavar='N', help='the number of workers of the dataloader')
