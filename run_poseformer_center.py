...
from common.model_center import *
...
if not args.evaluate:
    ...
    train_generator = ChunkedGenerator(args.batch_size//args.stride, cameras_train, poses_train, poses_train_2d, poses_train_2d_gt, args.stride,
                                        ...
                                        kps_left=kps_left, kps_right=kps_right, joints_left=joints_left, joints_right=joints_right, inter=True)
    ...
    while epoch < args.epochs:
        ...
        if True:
            for cameras_train, batch_3d, batch_2d, batch_2d_gt in train_generator.next_epoch():
                ...
                elif args.model_type == 'ext' or 'ext-slight':
                    predicted_3d_pos, predicted_3d_pos_inter = model_pos_train(inputs_2d, inputs_3d)
                else:
                ...
                loss_3d_pos = mpjpe(predicted_3d_pos, inputs_3d[:, inputs_3d.shape[1]//2 : inputs_3d.shape[1]//2 + 1])

                inputs_3d_inter = inputs_3d.view(inputs_3d.shape[0], 9, -1, 17, 3)
                inputs_3d_inter = inputs_3d_inter[:, :, inputs_3d_inter.shape[2]//2, :, :]
                loss_3d_pos_inter = mpjpe(predicted_3d_pos_inter, inputs_3d_inter)
                if args.attack:
                    loss_3d_pos_adv = mpjpe(predicted_3d_pos_adv, inputs_3d)
                inputs_3d = inputs_3d[:, inputs_3d.shape[1]//2 : inputs_3d.shape[1]//2 + 1]
                ...
                if args.motion_loss:
                    loss_motion = motion_loss(predicted_3d_pos_inter, inputs_3d_inter)
                    loss_total = loss_total + loss_motion
